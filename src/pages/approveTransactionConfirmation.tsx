...
stating that a transaction has been approved.
-----------------------------------------------------------------------*/
...
// This function creates the front-end display of the webpage.
function ApproveTransactionConfirmation () {
    ...
    return(
        <div>
            ...
            {/* Approval message */}
            <h1>This transaction has been approved!</h1>
...
export default ApproveTransactionConfirmation;
