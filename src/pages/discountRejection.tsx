/*------------------------------------------------ 
Author: Tytrez Dixon
Date Written: 3/5/2025
Date Updated: 3/8/2025

This is the .tsx file for the vehicle discount rejection 
page for Mr.Tucker's Car Dealership's web application.
On this page, the owner will see that a discount
on a vehicle has not been applied.
------------------------------------------------ */
    ...
    return (
        <div>
            ...
            <div className = {menuVisible ? "menu-visible" : "menu-hidden"}>
                ...
                <h2>A new discount has not been applied.</h2>
...
// Mandatory export defualt statement.
