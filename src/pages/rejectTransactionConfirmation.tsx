...
stating that a transaction has been rejected.
-----------------------------------------------------------------------*/
...
// This function creates the front-end display of the webpage.
function RejectTransactionConfirmation () {
    ...
    return(
        <div>
            ...
            {/* Approval message */}
            <h1>This transaction has been rejected.</h1>
...
export default RejectTransactionConfirmation;
