...
stating that a transaction has not been approved.
-----------------------------------------------------------------------*/
...
// This function creates the front-end display of the webpage.
function ApproveTransactionDenial () {
    ...
    return(
        <div>
            ...
            {/* Approval message */}
            <h1>This transaction has not been approved.</h1>
...
export default ApproveTransactionDenial;
