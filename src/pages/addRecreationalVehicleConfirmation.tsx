...
This is the .tsx file for the "Add Recreational Vehicle Confirmation" webpage
for Mr.Tucker's Car Dealership's web application. On this page, the 
user will see a confirmation message which states that the Recreational
vehicle in question has been added to the Recreational lot of the vehicle
inventory.
--------------------------------------------------------------------*/
...
function AddRecreationalVehicleConfrimation () {
    ...
    return (
        <div>
            ...
            <div style = {{justifyItems: "center", marginTop: "200px" }}>
                <div>
                    <h1>Your vehicle has been successfully added to the Recreational lot!</h1>
                </div>
...
export default AddRecreationalVehicleConfrimation;
