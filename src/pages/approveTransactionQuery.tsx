...
This is the .tsx file for a certain page of the "Approve Sales/Orders"
page series. On this specific page, the owner will be asked if they
actually want to approve a transaction.
-----------------------------------------------------------------------*/
...
function ApproveTransactionQuery () {
    ...
    return(
        <div>
            ...
            {/* Approval query */}
            <h1>Are you sure you want to approve this transaction?</h1>
            ...
            <div className="vehicle-details-container">
                ...
                <div className="button-container">
                    ...
                    <button className="purchase-button"
                            ...
                            onClick = {() => navigate('/approveTransactionConfirmation')}>
                                Yes</button>

                    <button className="back-button" 
                            onClick={() => navigate('/approveTransactionDenial')}>
                                No</button>
                </div>
            </div>
...
export default ApproveTransactionQuery;
