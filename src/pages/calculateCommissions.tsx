/*----------------------------------------------------------------------
Author: Tytrez Dixon 
Date Written: 4/5/2025
Date Updated: 

This is the .tsx file for the "Calculate Commissions" page for 
Mr.Tucker's Car Dealership's web application. On this page, the 
owner will be able to view the chosen salesperson's total commissions
...
function CalculateCommissions() {
    ...
    return (
        <div>
            ...
            {/* Display salesperson's commissions */}
            <div style = {{justifyItems: "center"}}>
                <br></br>
                <h2>
                    Based on {salesperson.name}'s recent sales, their total commission is: ${salesperson.commission}
                </h2>
            </div>
