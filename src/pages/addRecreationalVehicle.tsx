...
Date Upated: ___________

This is the .tsx file for entering vehicle information 
about a vehicle which will be added to the Recreational lot
...
function AddRecreationalVehicle () {
    ...
    return (
        <div>
            ...
            onClick={() => navigate('/addRecreationalVehicleConfirmation')}
            >
                Submit
            </div>
...
export default AddRecreationalVehicle;
