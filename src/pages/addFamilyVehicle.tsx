...
about a vehicle which will be added to the Family lot
...
function AddFamilyVehicle () {
    ...
    return (
        <div>
            ...
            onClick={() => navigate('/addFamilyVehicleConfirmation')}
            >
                Submit
            </div>
...
export default AddFamilyVehicle;
