...
const Manufacturer5: React.FC = () => {
    const navigate = useNavigate();

    return (
    <div className='dealership-details-container'>
        <h1>Manufacturer 5</h1>
        <p>Welcome to Manufacturer 5! We offer a great selection of new and used cars</p>
